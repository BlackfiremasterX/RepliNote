...
import com.deepdweller.replinote.LinkMovementMethod
import com.deepdweller.replinote.R
import com.deepdweller.replinote.databinding.ActivityTakeNoteBinding
...
class TakeNote : ReplinoteActivity() {
    ...
    override fun receiveSharedNote() {
        ...
        Toast.makeText(this, R.string.saved_to_replinote, Toast.LENGTH_SHORT).show()
    }
