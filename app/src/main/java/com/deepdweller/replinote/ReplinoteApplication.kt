...
import com.deepdweller.replinote.helpers.SettingsHelper.Theme

class ReplinoteApplication : Application(), SharedPreferences.OnSharedPreferenceChangeListener {
